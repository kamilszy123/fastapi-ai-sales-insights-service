...
def get_offer_name_performance(
    ...
    return analytics_service.get_offer_name_performance(current_user.id, offer_id)
...
def get_offer_price_performance(
    ...
    return analytics_service.get_offer_price_performance(current_user.id, offer_id)
